...
Before I can use ggplot 2 I need to install it on my computer. To do
this we can use the function `install.packages("ggplot2")`

> **N.B.** We never run `install.packages()` in our quarto doc (we run
> it only once in our R console) as it would re-install the package
...
line fit to the data and trn off the “gray” error region?
